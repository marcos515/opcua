...
function verifyArguments_ArgumentList(addressSpace, methodInputArguments, inputArguments) {
    ...
    return {
        ...
        statusCode: inputArgumentResults.includes(node_opcua_status_code_1.StatusCodes.BadTypeMismatch) ? node_opcua_status_code_1.StatusCodes.BadInvalidArgument : node_opcua_status_code_1.StatusCodes.Good
    };
}
