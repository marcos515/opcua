...
exports._addTwoStateDiscrete = exports.promoteToTwoStateDiscrete = exports.UATwoStateDiscrete = void 0;
...
class UATwoStateDiscrete extends ua_variable_1.UAVariable {
    /*
     * @private
     */
    _post_initialize() {
...
exports.UATwoStateDiscrete = UATwoStateDiscrete;
function promoteToTwoStateDiscrete(node) {
    ...
    node_opcua_assert_1.default(node instanceof UATwoStateDiscrete, "should now  be a UATwoStateDiscrete");
    const _node = node;
    _node._post_initialize();
    return _node;
}
exports.promoteToTwoStateDiscrete = promoteToTwoStateDiscrete;
register_node_promoter_1.registerNodePromoter(node_opcua_constants_1.VariableTypeIds.TwoStateDiscreteType, promoteToTwoStateDiscrete);
function _addTwoStateDiscrete(namespace, options) {
    const addressSpace = namespace.addressSpace;
    node_opcua_assert_1.default(!options.hasOwnProperty("ValuePrecision"));
