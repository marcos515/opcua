...
import { AddAnalogDataItemOptions, AddDataItemOptions, AddEnumerationTypeOptions, AddMethodOptions, AddMultiStateDiscreteOptions, AddMultiStateValueDiscreteOptions, AddObjectOptions, AddObjectTypeOptions, AddReferenceOpts, AddReferenceTypeOptions, AddTwoStateDiscreteOptions, AddTwoStateVariableOptions, AddVariableOptions, AddVariableTypeOptions, AddViewOptions, AddYArrayItemOptions, CreateDataTypeOptions, CreateNodeOptions, InitialState, Namespace as NamespacePublic, State, StateMachine, Transition, UAEventType, UAVariable as UAVariablePublic, UAVariableType as UAVariableTypePublic, YArrayItemVariable } from "../source";
...
export declare class UANamespace implements NamespacePublic {
     ...
     *      });
     */
    addMultiStateValueDiscrete(options: AddMultiStateValueDiscreteOptions): UAMultiStateValueDiscretePublic;
    /**
     *
     ...
     */
    addTwoStateVariable(options: AddTwoStateVariableOptions): UATwoStateVariablePublic;
    /**
     ...
     */
    addTwoStateDiscrete(options: AddTwoStateDiscreteOptions): UATwoStateDiscretePublic;
