...
function construct_demo_alarm_in_address_space(test, addressSpace) {
    ...
    node_opcua_assert_1.assert("1:TankLevelCondition" === tankLevel.findReferencesAsObject("HasCondition", true)[0].browseName.toString());
    node_opcua_assert_1.assert("UAExclusiveLimitAlarm" === tankLevel.findReferencesAsObject("HasCondition", true)[0].constructor.name.toString());
    // ----------------------------------------------------------------
