...
export interface ClientSubscription extends EventEmitter {
    ...
    monitor(itemToMonitor: ReadValueIdOptions, requestedParameters: MonitoringParametersOptions, timestampsToReturn: TimestampsToReturn, monitoringMode: MonitoringMode, done: (err: Error | null, monitoredItem?: ClientMonitoredItem) => void): void;
    /**
     * @method monitorItems
    ...
    setTriggering(triggeringItem: ClientMonitoredItemBase, linksToAdd: ClientMonitoredItemBase[] | null, linksToRemove: ClientMonitoredItemBase[] | null, callback: (err: Error | null, response?: SetTriggeringResponse) => void): void;
