...
export declare const doTraceMessage: RegExpMatchArray | null;
...
export declare const doTraceClientMessage: RegExpMatchArray | null;
export declare const doTraceClientRequestContent: RegExpMatchArray | null;
export declare const doTraceClientResponseContent: RegExpMatchArray | null;
